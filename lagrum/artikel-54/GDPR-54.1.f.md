...
**Nivå:** artikel 54.1 led f  
**Proveniens:** EUT L 119, 4.5.2016, s. 1, originallydelse (▼B). Bärare: konsoliderad text CELEX 02016R0679-20160504 (SV).

## Normtext (ordagrant)

*artikel 54.1 inledning*

> Varje medlemsstat ska fastställa följande i lag:

*artikel 54.1 led f*

> Vilka villkor som gäller för de skyldigheter som varje tillsynsmyndighets ledamot eller ledamöter och personal har, förbud mot handlingar, yrkesverksamhet och förmåner som står i strid därmed under och efter mandattiden och vilka bestämmelser som gäller för anställningens upphörande.
...
[← GDPR-54.1.e](GDPR-54.1.e.md)  ·  [Artikel 54](README.md)  ·  [Alla lagrum](../README.md)  ·  [GDPR-54.2 →](GDPR-54.2.md)
