...
|---|---|---|
| [GDPR-11.1](GDPR-11.1.md) | artikel 11.1 | Om de ändamål för vilka den personuppgiftsansvarige behandlar personuppgifter inte kräver eller inte längre kr… |
| [GDPR-11.2](GDPR-11.2.md) | artikel 11.2 | Om den personuppgiftsansvarige, i de fall som avses i punkt 1 i denna artikel, kan visa att denne inte är i st… |
