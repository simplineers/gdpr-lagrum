...
|---|---|---|
| [GDPR-80.1](GDPR-80.1.md) | artikel 80.1 | Den registrerade ska ha rätt att ge ett organ, en organisation eller sammanslutning utan vinstsyfte, som har i… |
| [GDPR-80.2](GDPR-80.2.md) | artikel 80.2 | Medlemsstaterna får föreskriva att ett organ, en organisation eller en sammanslutning enligt punkt 1 i den här… |
