...
## Infogad referens [1/1] — artikel 5.1

Hänvisning i normtexten: ”punkt 1”. Artikelns rubrik: Principer för behandling av personuppgifter.
...
- artikel 5.1 → ”denna förordning” (vag hänvisning)
- artikel 5.1 → artikel 89.1
...
[← GDPR-5.1.f](GDPR-5.1.f.md)  ·  [Artikel 5](README.md)  ·  [Alla lagrum](../README.md)
