...
> Varje medlemsstat ska till kommissionen anmäla de bestämmelser i sin lagstiftning som den antagit i enlighet med punkt 2, samt utan dröjsmål anmäla eventuell senare ändringslagstiftning eller ändringar som berör dem.

## Infogad referens [1/1] — artikel 85.2

Hänvisning i normtexten: ”punkt 2,”. Artikelns rubrik: Behandling och yttrande- och informationsfriheten.
...
- artikel 85.2 → kapitel II
- artikel 85.2 → kapitel III
- artikel 85.2 → kapitel IV
- artikel 85.2 → kapitel V
- artikel 85.2 → kapitel VI
- artikel 85.2 → kapitel VII
- artikel 85.2 → kapitel IX
...
[← GDPR-85.2](GDPR-85.2.md)  ·  [Artikel 85](README.md)  ·  [Alla lagrum](../README.md)
