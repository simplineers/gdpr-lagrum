...
> Varje tillsynsmyndighet ska underlätta inlämningen av klagomål enligt punkt 1 f genom åtgärder såsom ett särskilt formulär för ändamålet, vilket också kan fyllas i elektroniskt, utan att andra kommunikationsformer utesluts.

## Infogad referens [1/1] — artikel 57.1 led f

Hänvisning i normtexten: ”punkt 1 f”. Artikelns rubrik: Uppgifter.
...
- artikel 57.1 led f → ”denna förordning” (vag hänvisning)
- artikel 57.1 led f → artikel 80
...
[← GDPR-57.1.v](GDPR-57.1.v.md)  ·  [Artikel 57](README.md)  ·  [Alla lagrum](../README.md)  ·  [GDPR-57.3 →](GDPR-57.3.md)
