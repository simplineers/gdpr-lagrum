...
**Nivå:** artikel 30.1 led e  
**Proveniens:** EUT L 119, 4.5.2016, s. 1, originallydelse (▼B). Bärare: konsoliderad text CELEX 02016R0679-20160504 (SV).

## Normtext (ordagrant)

*artikel 30.1 inledning*

> Varje personuppgiftsansvarig och, i tillämpliga fall, dennes företrädare ska föra ett register över behandling som utförts under dess ansvar. Detta register ska innehålla samtliga följande uppgifter:
...
[← GDPR-30.1.d](GDPR-30.1.d.md)  ·  [Artikel 30](README.md)  ·  [Alla lagrum](../README.md)  ·  [GDPR-30.1.f →](GDPR-30.1.f.md)
