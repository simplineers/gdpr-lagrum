...
> En godkänd certifieringsmekanism i enlighet med artikel 42 får användas för att visa att kraven i punkterna 1 och 2 i den här artikeln följs.

## Infogad referens [1/2] — artikel 25.1

Hänvisning i normtexten: ”punkterna 1 och 2”. Artikelns rubrik: Inbyggt dataskydd och dataskydd som standard.
...
## Infogad referens [2/2] — artikel 25.2
...
- artikel 25.1 → ”denna förordning” (vag hänvisning)
...
[← GDPR-25.2](GDPR-25.2.md)  ·  [Artikel 25](README.md)  ·  [Alla lagrum](../README.md)
