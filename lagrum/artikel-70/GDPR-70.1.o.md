...
## Infogad referens [1/3] — artikel 42.5
...
## Infogad referens [2/3] — artikel 42.8

Hänvisning i normtexten: ”artikel 42.8”. Artikelns rubrik: Certifiering.

*artikel 42.8*

> Styrelsen ska samla alla certifieringsmekanismer och sigill och märkningar för dataskydd i ett register och offentliggöra dem på lämpligt sätt.

## Infogad referens [3/3] — artikel 42.7

Hänvisning i normtexten: ”artikel 42.7”. Artikelns rubrik: Certifiering.

*artikel 42.7*

> Certifiering ska utfärdas till en personuppgiftsansvarig eller ett personuppgiftsbiträde för en period på högst tre år och får förnyas på samma villkor under förutsättning att de relevanta kriterierna fortsätter att vara uppfyllda. Certifiering ska, i tillämpliga fall, återkallas av de certifieringsorgan som avses i artikel 43 eller av den behöriga tillsynsmyndigheten om kriterierna för certifieringen inte eller inte längre uppfylls.
...
[← GDPR-70.1.n](GDPR-70.1.n.md)  ·  [Artikel 70](README.md)  ·  [Alla lagrum](../README.md)  ·  [GDPR-70.1.p →](GDPR-70.1.p.md)
